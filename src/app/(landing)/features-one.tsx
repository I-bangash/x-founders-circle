          ...
          <div className="border-foreground/10 relative mt-16 grid gap-12 border-b pb-12 [--radius:1rem] md:grid-cols-2">
            <div>
              ...
              <Card className="aspect-video overflow-hidden px-6">
                <Card className="bg-muted/50 h-full translate-y-6 rounded-b-none border-b-0">
                  <CpuArchitecture />
                </Card>
              </Card>
            </div>
            <div>
              ...
              <Card className="aspect-video overflow-hidden">
                <Card className="bg-muted/50 h-full translate-6 rounded-bl-none border-r-0 border-b-0 pt-6 pb-0">
                  <AnimatedListCustom />
                </Card>
              </Card>
            </div>
