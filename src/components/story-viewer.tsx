  ...
  return (
    <button
      ...
      className={cn(
        ...
        "focus-visible:ring-ring rounded-lg focus-visible:ring-2 focus-visible:ring-offset-2",
        className
      )}
    ...
    >
      <div className="relative h-[72px] w-[72px]">
        ...
        <div className="bg-background absolute inset-[5px] rounded-full p-[2px]">
...
function StoryViewerModal({
  ...
  return (
    ...
    >
      ...
      >
        <div className="absolute top-0 right-0 left-0 z-10 bg-gradient-to-b from-black/60 to-transparent pt-2 pb-4">
          <ProgressBar
              ...
              {currentStory.type === "video" && (
                <button
                  ...
                  className={cn(
                    ...
                    "h-8 w-8 text-white transition-colors hover:bg-white/20",
        ...
        <div className="pointer-events-none absolute inset-y-0 right-0 left-0 hidden items-center justify-between px-4 md:flex">
          <button
            ...
            className={cn(
              ...
              "pointer-events-auto h-10 w-10 rounded-full bg-white/10 text-white transition-colors hover:bg-white/20",
              "focus-visible:ring-2 focus-visible:ring-white/50 focus-visible:outline-none",
