...
export function SignUpForm() {
  ...
  useEffect(() => {
    ...
    if (planFromCookie) {
      console.log(
        "[SignUpForm] - pending_checkout_plan cookie: ",
        planFromCookie
      );
    } else {
      console.log("[SignUpForm] - pending_checkout_plan cookie not found.");
    }
  }, []);
      ...
      <div className="relative z-20 hidden w-full items-center justify-center overflow-hidden border-l border-neutral-100 bg-white md:flex dark:border-neutral-800 dark:bg-neutral-900">
        <div className="mx-auto max-w-sm">
          ...
          <p className="mt-8 text-center text-base font-normal text-neutral-500 dark:text-neutral-400">
            ViralLaunch is loved by thousands of people across the world, be
            part of the community and join us.
          </p> */}
          {/* <SimpleThemeToggle /> */}
        </div>
