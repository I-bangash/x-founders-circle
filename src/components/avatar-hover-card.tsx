      ...
      <AnimatePresence>
        {isHovered && (
          <motion.div
            ...
            className={cn(
              "absolute top-0 left-0 z-10 overflow-hidden rounded-xl shadow-lg",
              ...
              >
                ...
                <div>
                  <motion.h3
                    ...
                    className="text-foreground text-lg leading-tight font-bold"
                  >
                    {name}
                  </motion.h3>
                ...
                {description && (
                  <motion.p
                    ...
                    className="text-foreground/80 line-clamp-2 text-sm leading-relaxed"
                  >
                    {description}
                  </motion.p>
                )}
