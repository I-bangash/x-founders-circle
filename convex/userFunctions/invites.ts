...
export const claimProfileInternal = internalMutation({
  ...
  handler: async (ctx, args) => {
    ...
    await ctx.db.patch(currentUser._id, {
      ...
      engagementsToday: dummyUser.engagementsToday,
      engagementsThisWeek: dummyUser.engagementsThisWeek,
      engagementsThisMonth: dummyUser.engagementsThisMonth,
      lastEngagementDate: dummyUser.lastEngagementDate,
      lastEngagementWeek: dummyUser.lastEngagementWeek,
      lastEngagementMonth: dummyUser.lastEngagementMonth,
      pointsUsed: dummyUser.pointsUsed,
      selectedTopOfTheList: dummyUser.selectedTopOfTheList,
